...
android {
    namespace = "com.yakuphanuslu.regltakip"
    compileSdk = 34

    defaultConfig {
        applicationId = "com.yakuphanuslu.regltakip"
        minSdk = 24
        targetSdk = 34
        versionCode = 1
        versionName = "1.0"
...
dependencies {
    ...
    // 3. Room (2.6.1 sürümü AGP 8.2.2 ile sorunsuz çalışır)
